...
urlpatterns = [
    ...
    path('courses/payment/process', PaymentProcessOne.as_view(), name='course_payment_process_one'),
    path('courses/payment/get_transaction/<int:pk>', getTransactionNumber.as_view(), name='get_transaction_number'),
    path('courses/payment/process/<int:course_id>/delete', DeleteTransaction.as_view(), name='delete_transaction'),
